Locales['en'] = {
    ...
    ["ent_id"] = "Entity ID",
    ["explode_player"] = "Person was exploded",
    ...
    ["give_money"] = "Gave %s %s",
    ["give_money_all"] = "Added %s to every Players",
    ["give_money_all_black"] = "Gave %s black/s to every Player",
    ["give_money_black"] = "Gave %s black/s to %s",
    ...
    ["playerdrunk"] = "Made Player Drunk",
    ["reason"] = "Reason",
    ["refueled_vehicle"] = "Refueled Vehicle",
    ["restarted_resource"] = "Restarted Resource",
    ["removed_stress_player"] = "Removed stress from Player",
    ...
    ["state_changed"] = "You have set the state for the vehicle.",
    ["take_money"] = "Removed %s from %s",
    ["take_money_black"] = "Removed %s black/s from %s",
    ...
    ["veh_deleted"] = "%s Vehicles Deleted",
    ["ped_deleted"] = "%s Peds Deleted",
    ["object_deleted"] = "%s Objects Deleted",
